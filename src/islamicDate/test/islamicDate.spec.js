describe('Islamic Date', function() {
  var islamicDate;

  beforeEach(module('ui.bootstrap.islamicDate'));
  beforeEach(inject(function (islamicDateObject) {
  ...
  describe('Islamic Date Object', function() {
    it('should convert correctly from Hijri to Gregorian', function() {
    	var dateTable = [[1420,0,1,1999,3,17],
    	     			[1420,0,12,1999,3,28],
    	     			[1420,0,23,1999,4,9],
    	     			[1420,1,4,1999,4,20],
    					[1420,1,15,1999,4,31],
    	...
    	angular.forEach(dateTable, function(d, i) {
    		var iDate = new islamicDate(d[0], d[1], d[2], 1, 1, 1, 0);
    		var gDate = new Date(d[3], d[4], d[5], 1, 1, 1, 0);
    		expect(iDate.valueOf()).toEqual(gDate.valueOf());
    	});
    });

    it('should convert correctly from Gregorian to Hijri', function() {
    	var dateTable = [[1997,1,1,1417,8,23],
    	 				[1997,1,12,1417,9,4],
    	 				[1997,1,23,1417,9,15] ,
    	 				[1997,2,6,1417,9,26],
    	 				[1997,2,17,1417,10,8],
    	...
    	angular.forEach(dateTable, function(d, i) {
    		var gDate = new Date(d[0], d[1], d[2], 1, 1, 1, 0);
    		var iDate = new islamicDate(gDate);
    		var iDate2 = new islamicDate(d[3], d[4], d[5], 1, 1, 1, 0);
    		expect(iDate.toString()).toEqual(iDate2.toString());
    	});
    });

    it('should return correct value of getDay()', function() {
    	var dateTable = [[1431, 0, 11, 1],
						[1431, 1, 3, 2],
						[1431, 2, 10, 3],
						[1431, 3, 23, 4],
						[1431, 6, 21, 6],
    	...
    	angular.forEach(dateTable, function(d, i) {
    		var iDate = new islamicDate(d[0], d[1], d[2], 1, 1, 1, 0);
    		expect(iDate.getDay()).toEqual(d[3]);
    	});
    });

    it('should return correct value of getDate()', function() {
    	expect(new islamicDate(1202, 8, 19).getDate()).toEqual(19);
    	expect(new islamicDate(1431, 0, 1).getDate()).toEqual(1);
    	expect(new islamicDate(1431, 0, 31).getDate()).toEqual(1);
    	expect(new islamicDate(1437, 0, 61).getDate()).toEqual(2);
    	expect(new islamicDate(1437, 0, 1, 24, 0, 0, 0).getDate()).toEqual(2);
    	expect(new islamicDate(1437, 0, 1, 48, 0, 0, 0).getDate()).toEqual(3);
    	expect(new islamicDate(1437, 0, 1, 1, 1440, 0, 0).getDate()).toEqual(2);
    	expect(new islamicDate(1437, 0, 1, 1, 1, 86400, 0).getDate()).toEqual(2);
    	expect(new islamicDate(1437, 0, 1, 1, 1, 1, 86400000).getDate()).toEqual(2);
    	expect(new islamicDate(1431, 1, 0).getDate()).toEqual(30);
    	expect(new islamicDate(1431, 1, -1).getDate()).toEqual(29);
    	expect(new islamicDate(1431, 1, -2).getDate()).toEqual(28);
    });
    
    it('should return correct value of getMonth()', function() {
    	expect(new islamicDate(1202, 8, 19).getMonth()).toEqual(8);
    	expect(new islamicDate(1431, 0, 30).getMonth()).toEqual(0);
    	expect(new islamicDate(1431, 0, 31).getMonth()).toEqual(1);
    	expect(new islamicDate(1437, 0, 61).getMonth()).toEqual(2);
    	expect(new islamicDate(1437, 0, 30, 24, 0, 0, 0).getMonth()).toEqual(1);
    	expect(new islamicDate(1437, 0, 30, 720, 0, 0, 0).getMonth()).toEqual(2);
    	expect(new islamicDate(1437, 0, 30, 1, 43200, 0, 0).getMonth()).toEqual(2);
    	expect(new islamicDate(1437, 0, 30, 1, 1, 2592000, 0).getMonth()).toEqual(2);
    	expect(new islamicDate(1437, 0, 30, 1, 1, 1, 2592000000).getMonth()).toEqual(2);
    	expect(new islamicDate(1431, 1, -1).getMonth()).toEqual(0);
    	expect(new islamicDate(1431, 1, -30).getMonth()).toEqual(11);
    	expect(new islamicDate(1431, -1, 1).getMonth()).toEqual(11);
    });
    
    it('should return correct value of getFullYear()', function() {
    	expect(new islamicDate(1202, 8, 19).getFullYear()).toEqual(1202);
    	expect(new islamicDate(1431, 11, 30).getFullYear()).toEqual(1431);
    	expect(new islamicDate(1431, 11, 31).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 12, 1).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 24, 1).getFullYear()).toEqual(1433);
    	expect(new islamicDate(1431, 11, 30, 24, 0, 0, 0).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 11, 30, 23, 60, 0, 0).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 60, 0).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 1000).getFullYear()).toEqual(1432);
    	expect(new islamicDate(1431, 0, -1).getFullYear()).toEqual(1430);
    	expect(new islamicDate(1431, -1, 1).getFullYear()).toEqual(1430);
    	expect(new islamicDate(1431, -13, 1).getFullYear()).toEqual(1429);
    });
    
    it('should return correct value of getHours()', function() {
    	expect(new islamicDate(1431, 24, 1).getHours()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 0, 0).getHours()).toEqual(23);
    	expect(new islamicDate(1431, 11, 30, 23, 60, 0, 0).getHours()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 60, 0).getHours()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 1000).getHours()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 24, 0, 0, 0).getHours()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, -1, 0, 0, 0).getHours()).toEqual(23);
    	expect(new islamicDate(1431, 11, 30, -2, 0, 0, 0).getHours()).toEqual(22);
    	expect(new islamicDate(1431, 11, 30, 3, -1, 0, 0).getHours()).toEqual(2);
    });
    
    it('should return correct value of getMinutes()', function() {
    	expect(new islamicDate(1431, 24, 1).getMinutes()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 0, 0).getMinutes()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, 63, 0, 0).getMinutes()).toEqual(3);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 120, 0).getMinutes()).toEqual(1);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 1000).getMinutes()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, -1, 0, 0).getMinutes()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, -2, 0, 0).getMinutes()).toEqual(58);
    	expect(new islamicDate(1431, 11, 30, 23, -61, 0, 0).getMinutes()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, 10, -1, 0).getMinutes()).toEqual(9);
    });
    
    it('should return correct value of getSeconds()', function() {
    	expect(new islamicDate(1431, 24, 1).getSeconds()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 0).getSeconds()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 63, 0).getSeconds()).toEqual(3);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 122, 0).getSeconds()).toEqual(2);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 2000).getSeconds()).toEqual(1);
    	expect(new islamicDate(1431, 11, 30, 23, 0, -1, 0).getSeconds()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, 0, -2, 0).getSeconds()).toEqual(58);
    	expect(new islamicDate(1431, 11, 30, 23, 0, -61, 0).getSeconds()).toEqual(59);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 10, -1).getSeconds()).toEqual(9);
    });
    
    it('should return correct value of getMilliseconds()', function() {
    	expect(new islamicDate(1431, 24, 1).getMilliseconds()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, 999).getMilliseconds()).toEqual(999);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 0, 1000).getMilliseconds()).toEqual(0);
    	expect(new islamicDate(1431, 11, 30, 23, 0, 0, 1002).getMilliseconds()).toEqual(2);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, -10).getMilliseconds()).toEqual(990);
    	expect(new islamicDate(1431, 11, 30, 23, 59, 59, -1010).getMilliseconds()).toEqual(990);
    });
